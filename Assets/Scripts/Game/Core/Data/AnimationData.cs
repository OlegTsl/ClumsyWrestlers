...
namespace Game.Core.Data
{
    public static class AnimationData
    {
        ...
        public static readonly int SimpleAttackSpeed =
            Animator.StringToHash("SimpleAttackSpeed");
        public static readonly int PowerAttackSpeed =
            Animator.StringToHash("PowerAttackSpeed");
        ...
        public static readonly int MirrorPunch =
            Animator.StringToHash("MirrorPunch");
        public static readonly int PowerAttackTrigger =
